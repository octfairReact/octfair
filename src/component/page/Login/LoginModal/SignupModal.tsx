...
export const SignupModal = () => {
  ...
  const completeEnterHandler = (event) => {
    if (event.key === "Enter") completeRegisterHandler();
  };
  ...
  const completeRegisterHandler = () => {
    ...
    if (isProblem === false) {
      if (!passwordRules.test(signupInput.password)) {
    ...
    if (isProblem === false) {
      ...
      axios
        .get(Login.postSignup + queryString)
        .then((res) => {
  ...
  const checkIdDuplicateHandler = async () => {
    ...
    await axios
      .post(Login.getCheckId, qs.stringify({ loginId: signupInput.loginId }))
      .then((res) => {
        if (res.data === 1) {
          // 결과값이 1이면 중복이란 뜻 (Mapper에서 해당id의 갯수를 반환하기 때문)
      ...
      <ModalOverlay onMouseDown={closeModalHandler}>
        ...
        <ModalStyled onMouseDown={(e) => e.stopPropagation()}>
          ...
          <Table onKeyDown={completeEnterHandler} tabIndex={-1}>
            {" "}
            {/* 'tabIndex={-1}' 의미: 모달의 포커싱을 없애서 부모페이지의 ESC닫기Handler 작동을 가능하게 하는 용도 */}
              ...
              <tr>
                ...
                <TableDataCell colSpan={3}>
                  <SelectBox
                    ...
                    onChange={(e) => {
                      setSignupInput((prev) => ({ ...prev, userType: e.target.value }));
                    }}
                  >
              ...
              <tr>
                ...
                <TableDataCell colSpan={2}>
                  <InputField
                    ...
                    onChange={(e) => {
                      setSignupInput((prev) => ({ ...prev, loginId: e.target.value }));
              ...
              <tr>
                ...
                <TableDataCell colSpan={3}>
                  <InputField
                    ...
                    id="passwordOk"
                    onChange={(e) => {
                      setSignupInput((prev) => ({ ...prev, passwordOk: e.target.value }));
                    }}
                  ></InputField>
                </TableDataCell>
              </tr>
              ...
              <tr>
                ...
                <TableDataCell colSpan={3}>
                  <SelectBox
                    name="sex"
                    id="sex"
                    value={signupInput.sex}
                    onChange={(e) => {
                      setSignupInput((prev) => ({ ...prev, sex: e.target.value }));
                    }}
                  >
                    <option value="" disabled>
                      선택
              ...
              <tr>
                ...
                <TableDataCell colSpan={3}>
                  <InputField
                    ...
                    id="birthday"
                    onChange={(e) => {
                      setSignupInput((prev) => ({ ...prev, birthday: e.target.value }));
                    }}
                  ></InputField>
                </TableDataCell>
              </tr>
              <tr>
                ...
                <TableDataCell colSpan={3}>
                  <InputField
                    ...
                    placeholder="숫자만 입력"
                    onChange={(e) => {
                      setSignupInput((prev) => ({ ...prev, phone: e.target.value }));
                    }}
                  ></InputField>
                </TableDataCell>
              </tr>
              ...
              <tr>
                ...
                <TableDataCell colSpan={2}>
                  <InputField
                    ...
                    id="zipCode"
                    placeholder="숫자만 입력"
                    value={signupInput.zipCode}
                    onChange={(e) => {
                      setSignupInput((prev) => ({ ...prev, zipCode: e.target.value }));
                    }}
                  ></InputField>
                </TableDataCell>
                <TableDataCell>
              ...
              <tr>
                ...
                <TableDataCell colSpan={3}>
                  <InputField
                    ...
                    onChange={(e) => {
                      setSignupInput((prev) => ({ ...prev, address: e.target.value }));
                    }}
                  ></InputField>
                </TableDataCell>
              </tr>
              <tr>
                ...
                <TableDataCell colSpan={3}>
                  <InputField
                    ...
                    id="detailAddress"
                    onChange={(e) => {
                      setSignupInput((prev) => ({ ...prev, detailAddress: e.target.value }));
                    }}
                  ></InputField>
                </TableDataCell>
              </tr>
