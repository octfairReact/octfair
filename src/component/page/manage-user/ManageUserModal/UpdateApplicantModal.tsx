                    ...
                    <Table onKeyDown={completeEnterHandler}>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <TableDataCell>
                                    <SelectBox name="userType" id="updateUserType" value={userData.userType}
                            ...
                            <tr>
                                ...
                                <TableDataCell colSpan={3}>
                                    <InputField type="text" id="updateId" placeholder="숫자, 영문자 조합으로 6~20자리" value={userData.loginId} readOnly
                            ...
                            <tr>
                                ...
                                <TableDataCell>
                                    <InputField type="text" id="updateName" value={userData.name}
                                        onChange={(e) => { setUserData((prev) => ({ ...prev, name: e.target.value })); }}>
                                    </InputField>
                                </TableDataCell>
                                <TableHeaderCell>성별 <RequiredMark>*</RequiredMark></TableHeaderCell>
                                <TableDataCell>
                                    <SelectBox name="sex" id="updateSex" value={userData.sex}
                            ...
                            <tr>
                                ...
                                <TableDataCell colSpan={3}>
                                    <InputField type="date" id="updateBirthday" value={userData.birthday}
                            ...
                            <tr>
                                ...
                                <TableDataCell colSpan={3}>
                                    <InputField type="tel" id="updatePhone" placeholder="숫자만 입력" value={userData.phone}
                            ...
                            <tr>
                                ...
                                <TableDataCell colSpan={3}>
                                    <InputField type="email" id="updateEmail" placeholder="이메일@도메인 양식으로 입력" value={userData.email}
                            ...
                            <tr>
                                ...
                                <TableDataCell colSpan={3}>
                                    <InputField type="date" id="updateRegdate" value={userData.regdate}
                            ...
                            <tr>
                                ...
                                <TableDataCell>
                                    <SelectBox name="userType" id="updateStatusYn" value={userData.statusYn}
                            ...
                            <tr>
                                ...
                                <TableDataCell colSpan={2}>
                                    <InputField type="text" id="updateZipCode" value={userData.zipCode}
                            ...
                            <tr>
                                ...
                                <TableDataCell colSpan={3}>
                                    <InputField type="text" id="updateAddress" value={userData.address}
                            ...
                            <tr>
                                ...
                                <TableDataCell colSpan={3}>
                                    <InputField type="text" id="updateDetailAddress" value={userData.detailAddress}
