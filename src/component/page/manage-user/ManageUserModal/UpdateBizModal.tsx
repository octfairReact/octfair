                        ...
                        <tbody>
                            <tr>
                                ...
                                <TableDataCell colSpan={3}>
                                    <InputField type="number" id="updateId" value={userData.bizIdx} readOnly
                            ...
                            <tr>
                                ...
                                <TableDataCell colSpan={3}>
                                    <InputField type="text" id="updateId" value={userData.bizName}
                            ...
                            <tr>
                                ...
                                <TableDataCell colSpan={3}>
                                    <InputField type="text" id="updateId" value={userData.bizCeoName}
                            ...
                            <tr>
                                ...
                                <TableDataCell colSpan={3}>
                                    <InputField type="text" id="updateId" value={userData.bizEmpCount}
                            ...
                            <tr>
                                ...
                                <TableDataCell colSpan={3}>
                                    <InputField type="text" id="updateId" value={userData.bizRevenue}
                            ...
                            <tr>
                                ...
                                <TableDataCell colSpan={3}>
                                    <InputField type="text" id="updateId" placeholder="숫자만 입력" value={userData.bizContact}
                            ...
                            <tr>
                                ...
                                <TableDataCell colSpan={3}>
                                    <InputField type="text" id="updateId" value={userData.bizAddr}
                            ...
                            <tr>
                                ...
                                <TableDataCell colSpan={3}>
                                    <InputField type="text" id="updateId" value={userData.bizWebUrl}
                            ...
                            <tr>
                                ...
                                <TableDataCell colSpan={3}>
                                    <InputField type="date" id="updateBirthday" value={userData.bizFoundDate}
                            ...
                            <tr>
                                ...
                                <TableDataCell colSpan={3}>
                                    <InputField type="text" id="updateId" value={userData.bizIntro}
