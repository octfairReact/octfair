...
export const MyPageUpdateMain = () => {
  ...
  const completeEnterHandler = (event) => {
    if (event.key === "Enter" && updatePasswordModal === false) completeUpdateHandler();
  };
  ...
  const completeUpdateHandler = async () => {
    ...
    Object.entries(updateInput).some(([key, value]) => {
      // 입력값이 많아서 반복문처리, signupInput이 배열은 아니어서 forEach()/map()대신 Object.entries()
  ...
  const updatePasswordHandler = () => {
    if (updatePasswordModal === false) setUpdatePasswordModal(true);
  };
  ...
  return (
    <>
          ...
          <tr>
            ...
            <TableDataCell colSpan={3}>
              <InputField
                ...
                readOnly // 아이디 칸은 읽기전용
                onChange={(e) => {
                  setUpdateInput((prev) => ({ ...prev, loginId: e.target.value }));
                }}
              ></InputField>
            </TableDataCell>
          </tr>
          ...
          <tr>
            ...
            <TableDataCell>
              <SelectBox
                name="sex"
                id="sex"
                value={updateInput.sex}
                onChange={(e) => {
                  setUpdateInput((prev) => ({ ...prev, sex: e.target.value }));
                }}
              >
          ...
          <tr>
            ...
            <TableDataCell colSpan={3}>
              <InputField
                type="date"
                id="birthday"
                value={updateInput.birthday}
                onChange={(e) => {
                  setUpdateInput((prev) => ({ ...prev, birthday: e.target.value }));
                }}
              ></InputField>
            </TableDataCell>
          </tr>
          <tr>
            ...
            <TableDataCell colSpan={3}>
              <InputField
                ...
                onChange={(e) => {
                  setUpdateInput((prev) => ({ ...prev, phone: e.target.value }));
                }}
              ></InputField>
            </TableDataCell>
          </tr>
          <tr>
            ...
            <TableDataCell colSpan={3}>
              <InputField
                ...
                onChange={(e) => {
                  setUpdateInput((prev) => ({ ...prev, email: e.target.value }));
                }}
              ></InputField>
            </TableDataCell>
          </tr>
          ...
          <tr>
            ...
            <TableDataCell colSpan={2}>
              <InputField
                type="text"
                id="zipCode"
                value={updateInput.zipCode}
                onChange={(e) => {
                  setUpdateInput((prev) => ({ ...prev, zipCode: e.target.value }));
                }}
              ></InputField>
            </TableDataCell>
            <TableDataCell>
          ...
          <tr>
            ...
            <TableDataCell colSpan={3}>
              <InputField
                ...
                onChange={(e) => {
                  setUpdateInput((prev) => ({ ...prev, address: e.target.value }));
                }}
              ></InputField>
            </TableDataCell>
          </tr>
          <tr>
            ...
            <TableDataCell colSpan={3}>
              <InputField
                type="text"
                id="detailAddress"
                value={updateInput.detailAddress}
                onChange={(e) => {
                  setUpdateInput((prev) => ({ ...prev, detailAddress: e.target.value }));
                }}
              ></InputField>
            </TableDataCell>
          </tr>
      ...
      <div style={{ display: "flex", gap: "10px", marginTop: "20px" }}>
        ...
        <Button onClick={() => {}} style={{ backgroundColor: "#6c757d", borderColor: "#6c757d" }}>
          취소
        </Button>
      </div>
      {updatePasswordModal !== false && <MyPageUpdatePasswordModal />}
    </>
  );
};
