        ...
        <>
            ...
            <StyledTable>
                <thead>
                    ...
                    <tr>
                        <th>채용기간</th>
                        <td><Calendar label={"시작 날짜"}  onDateChange={(date) => (startDate.current = date)} ></Calendar></td>
                        <td><Calendar label={"종료 날짜"}  onDateChange={(date) => (endDate.current = date)} ></Calendar></td>
                    </tr>
                    <tr>
                        <th>채용절차</th>
                        <td>
