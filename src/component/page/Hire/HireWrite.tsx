...
export const HireWrite = () => {
  ...
  const handleCheckboxChange = (id: number) => {
    setCheckBox((prevCheckBox) =>
      prevCheckBox.map((checkBox) => (checkBox.id === id ? { ...checkBox, checked: !checkBox.checked } : checkBox))
    );
  };
      ...
      <StyledTable>
        <thead>
          ...
          <tr>
            <th>채용기간</th>
            <td>
              <Calendar label={"시작날짜"} onDateChange={handleStartDateChange}></Calendar>
            </td>
            <td>
              <Calendar label={"끝나는날짜"} onDateChange={handleStartDateChange}></Calendar>
            </td>
          </tr>
          <tr>
            <th>채용절차</th>
